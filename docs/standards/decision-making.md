...
When instructions conflict, apply the following order from highest to lowest priority:
...
3. Approved roles, plans, permissions, and resource constraints.
4. Authorized task goals and instructions from an authenticated stakeholder.
